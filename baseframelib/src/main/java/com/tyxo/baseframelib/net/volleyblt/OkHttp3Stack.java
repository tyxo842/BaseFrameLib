...
import com.tyxo.baseframelib.net.volleyblt.cookie.ClearableCookieJar;
import com.tyxo.baseframelib.net.volleyblt.cookie.LoggerInterceptor;
import com.tyxo.baseframelib.net.volleyblt.cookie.PersistentCookieJar;
import com.tyxo.baseframelib.net.volleyblt.cookie.cache.SetCookieCache;
import com.tyxo.baseframelib.net.volleyblt.cookie.persistence.SharedPrefsCookiePersistor;
...
public class OkHttp3Stack implements HttpStack {
    ...
    public OkHttp3Stack(Context context) {
        ...
        mClient = new OkHttpClient.Builder().readTimeout(timeoutMs, TimeUnit.MILLISECONDS)
                .connectTimeout(timeoutMs, TimeUnit.MILLISECONDS).writeTimeout(timeoutMs, TimeUnit.MILLISECONDS)
                .addInterceptor(logging).cookieJar(cookieJar) // 自动化管理cookie
